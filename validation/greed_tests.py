def validate(function):
    INPUTS = [
        ...
        [5, 1, 3],
        [0, -2, 2],
        [300, 265, 139, 167, 20, 132, 272, 55, 125, 146, 244, 251, -8, -29, 118, 223, 209, -50, 279, 97, 34, 293, -15, 6, -22, 111, 41, 202, 195, 181, 83, 286, 90, 69, 104, 153, 62, -36, 13, 216, 258, 27, -43, -1, 48, 237, 230, 174, 188, 76],
    ]
    EXP_OUTPUTS = [
        3,
        2,
